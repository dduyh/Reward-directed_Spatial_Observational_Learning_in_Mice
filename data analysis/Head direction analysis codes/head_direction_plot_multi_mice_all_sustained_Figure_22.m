...
title('Sustained Attention HD Timeseries (Cue)' ,'FontSize',14,'FontWeight','bold')

savefig([Directory '\' 'Sustained_head_direction_timeseries.fig']);
f = getframe(gcf);
imwrite(f.cdata,[Directory '\' 'Sustained_head_direction_timeseries.png']);
