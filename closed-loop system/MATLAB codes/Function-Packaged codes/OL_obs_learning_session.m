...
%(Step 3: Provide food for Observer mice, when the Demo mouse find the reward;)
...
%%
function [] = OL_obs_learning_session(Folder,s,vid_maze,background,coordinates_in_left,bw_in_left, ...
