...
%%
function [] = OL_obs_training(Folder,s,vid_maze,background,coordinates_in_right,bw_in_right, ...
...
while toc(tStart) < trial_length
    ...
    if Step_2
        if sum(cage_out_right,'all') < cage_out_thresh
            ...
            disp('Step 2: Close the right cage door, Demo mouse is leaving the right cage    ');
            Step_2 = 0;
